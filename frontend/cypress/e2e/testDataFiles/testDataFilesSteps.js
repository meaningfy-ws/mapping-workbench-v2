...
Then('I click on Test Data Files', () => {
  cy.get('#nav_test_data_files').click();
});

Then('I get redirected to Test Data Files page', () => {
  cy.title().should('eq', 'App: Test Data Files | Mapping Workbench 2');
});
...
Then('I get redirected to edit page', () => {
  cy.title().should('eq', 'App: Edit Test Data Files | Mapping Workbench 2');
});
